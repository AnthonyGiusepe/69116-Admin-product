...
const products = JSON.parse(localStorage.getItem('productos')) || []// null
...
function deleteProduct(identificador) {
    ...
    // lo mismo que arriba pero con la libreria swal

    Swal.fire({
        title: '¿Estás seguro?',
        text: 'Una vez eliminado, no podras recuperar el producto',
        icon: 'warning',
